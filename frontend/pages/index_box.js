...
export default function Home() {
  ...
  const ResultDisplay = () => {
    ...
    const getScoreColor = (score) => {
      if (score >= 80) return '#FFD700'; // 금색 (excellent)
      if (score >= 60) return '#4CAF50'; // 초록 (good)
      if (score >= 40) return '#FF9800'; // 오렌지 (fair)
      return '#F44336'; // 빨강 (poor)
    };
      ...
      <div className={`result-box ${showResult ? 'show' : ''}`}>
        ...
        <div className="comfort-section">
          ...
          <div 
            className="score-box"
            style={{
              background: `linear-gradient(135deg, ${scoreColor}22, ${scoreColor}44)`,
